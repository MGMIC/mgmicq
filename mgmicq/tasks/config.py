...
amplicon_workflow_config = {"mgmic.oscer.ou.edu":
                    ...
                    "10.196.99.178":
                    	{"docker_opts":["-v /Users/mstacy/data_munge/risser_crazy/data:/data -v /Users/mstacy/data_munge/risser_crazy/data/local/scripts:/opt/local/scripts",
                         ...
                         "docker_cmd":[  "eval '$(docker-machine env default)' && /opt/local/scripts/bin/Illumina_MySeq_16SAmplicon_analysis_part1.pl %s %s %s",
                                         "eval '$(docker-machine env default)' && /opt/local/scripts/bin/Illumina_MySeq_16SAmplicon_analysis_part2.pl %s %s %s"]
                        },
             		}
