...
def mgmic_16s_classification(forward_read_url, reverse_read_url, basedir="/data/static/"):
    ...
    try:
        ...
        docker_opts = "-t -v /opt:/opt -v /data:/data"
        docker_cmd = "/opt/local/scripts/bin/classify_metagenome_by_16S_step2_display.pl %s %s %s" % (foward_read,reverse_read,resultDir)
